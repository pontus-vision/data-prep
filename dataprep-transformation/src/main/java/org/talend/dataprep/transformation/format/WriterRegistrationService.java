...
public class WriterRegistrationService {
     ...
     */
    public TransformerWriter getWriter(String format, Map<String, String> parameters) {
        try {
            ...
            if (parameters.isEmpty()) {
                return (TransformerWriter) context.getBean("writer#" + format);
            } else {
                return (TransformerWriter) context.getBean("writer#" + format, parameters);
            }
