 ...
 */
@Service
public class DefaultStepMetadataRepository implements StepMetadataRepository {

    /**
     * This class' logger.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultStepMetadataRepository.class);
