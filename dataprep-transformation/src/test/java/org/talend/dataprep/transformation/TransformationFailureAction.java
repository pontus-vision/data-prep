 ...
 */
@Action(TransformationFailureAction.TRANSFORMATION_FAILURE_ACTION)
public class TransformationFailureAction extends AbstractActionMetadata
        implements ColumnAction, CellAction, DataSetAction {
