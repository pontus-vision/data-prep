...
public class SeparatorAnalyzer implements Consumer<Separator> {
    ...
    public void accept(Separator separator) {
        ...
        CsvFastHeaderAndTypeAnalyzer
                csvFastHeaderAndTypeAnalyzer = new CsvFastHeaderAndTypeAnalyzer(sampleLines, separator);
        ...
        separator.setHeaders(csvFastHeaderAndTypeAnalyzer.getHeaders().stream().map(Pair::getKey).collect(Collectors.toList()));
    }
