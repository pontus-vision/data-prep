...
public class XlsUtils {
    ...
    public static boolean isNewExcelFormat(InputStream inputStream) throws IOException {
        ...
        if (!inputStream.markSupported()) {
            // POI doc refer to the PushBackInputStream as supporting mark() but it is a bug
            // WARN : using this BufferedStream will read the first bytes of the original stream. Use this created stream after
            throw new RuntimeException("This method has been called with an inproper InputStream.");
        }
