...
public class DataSetList extends GenericCommand<InputStream> {
    ...
    private InputStream transformToLegacy(HttpRequestBase request, HttpResponse response) {
        ...
        List<DataSetMetadata> metadata = Arrays.stream(dataSets) //
                .map(dataset -> beanConversionService.convert(dataset, DataSetMetadata.class)) //
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
            ...
            objectMapper.writerFor(DataSetMetadata.class) //
                    .writeValues(writer) //
                    .writeAll(metadata);
