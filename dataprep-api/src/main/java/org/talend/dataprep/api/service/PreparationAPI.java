...
public class PreparationAPI extends APIService {
    ...
    public String deletePreparation(
        ...
        PreparationCacheDelete preparationCacheDelete = getCommand(PreparationCacheDelete.class, id);
        final PreparationDelete preparationDelete = getCommand(PreparationDelete.class, id, preparationCacheDelete);
