...
/**
 * Base class for all 1.3.0-PE upgrade task tests.
 */
@TestPropertySource(locations = { "to_2_1_0_PE.properties" })
public abstract class Base_2_1_0_PE_Test extends BasePEUpgradeTest {
