...
/**
 * Base interface for the 2.1.0-EE upgrade.
 */
public abstract class BaseUpgradeTaskTo_2_3_0_PE implements UpgradeTask {

    @Override
    public UpgradeTaskId getId() {
        return getTaskId("2.3.0-PE", this.getClass().getSimpleName());
    }
