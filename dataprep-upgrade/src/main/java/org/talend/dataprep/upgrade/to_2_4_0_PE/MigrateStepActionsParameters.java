...
import org.talend.dataprep.upgrade.common.SplitParametersUpgrade;
import org.talend.dataprep.upgrade.model.UpgradeTask;

@Component
public class MigrateStepActionsParameters extends BaseUpgradeTaskTo_2_4_0_PE {
    ...
    @Override
    public void run() {
        SplitParametersUpgrade.upgradeActions(preparationRepository);
    }
