...
public class AggregateFunctionsTest {
    ...
    public void testNullUniqueFunction() throws Exception {
        final BiFunction<Object, Object, Object> function =
                AggregateFunctions.aggregate(Collections.singletonList(null));
    ...
    public void testEmptyResults() throws Exception {
        final BiFunction<Object, Object, Object> function =
                AggregateFunctions.aggregate(Arrays.asList((o1, o2) -> null, (o1, o2) -> null));
        assertThat(function.apply(null, null), nullValue());
    }
    ...
    public void testSingleFunction() throws Exception {
        final BiFunction<String, String, String> function =
                AggregateFunctions.aggregate(Collections.singletonList((s1, s2) -> s1 + s2));
    ...
    public void testMultipleFunction() throws Exception {
        final BiFunction<String, String, String> function =
                AggregateFunctions.aggregate(Arrays.asList((s1, s2) -> s1 + s2, (s1, s2) -> s2 + s1));
        assertThat(function.apply(null, null), is("nullnull"));
